 ...
 * @author JovenLoba
 */
public class JDialogViewBillsAndPlacedOrder extends javax.swing.JDialog {

  /**
   * Creates new form JDialogViewBillsAndPlacedOrdere
   */
  public JDialogViewBillsAndPlacedOrder(java.awt.Frame parent, boolean modal) {
    super(parent, modal);
    initComponents();
      frameSizeLocation();
...
//    setLocation(200,100);
  ...
  private void initComponents() {
    ...
    jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/storeHome.png"))); // NOI18N
...
getTAbleDetails();    // TODO add your handling code here:
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(JDialogViewBillsAndPlacedOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        JDialogViewBillsAndPlacedOrder dialog = new JDialogViewBillsAndPlacedOrder(new javax.swing.JFrame(), true);
