 ...
 * @author JovenLoba
 */
public class JDialogTempPurchaseEntry extends javax.swing.JDialog {
  ...
  /**
   * Creates new form JDialogTempPurchaseEntry
   */
  public JDialogTempPurchaseEntry(Frame parent, boolean modal, String email) {
    super(parent, modal);
...
private void initialize_Inputs(){
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(JDialogTempPurchaseEntry.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        JDialogTempPurchaseEntry dialog = new JDialogTempPurchaseEntry(new javax.swing.JFrame(), true, user_Email);
...
//    new SavePurchase(entrylist,user_Email).setVisible(true)  ;
    JDialogSavePurchase jdialogsavepurchase = new JDialogSavePurchase(this,true,entrylist,user_Email);
    jdialogsavepurchase.setVisible(true);
//    fill_Table();
  }
